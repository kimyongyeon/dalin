package com.dalin.hosting.domain.init;

import com.dalin.hosting.domain.code.CommonCode;
import com.dalin.hosting.domain.code.CommonCodeService;
import com.dalin.hosting.domain.program.Program;
import com.dalin.hosting.domain.program.ProgramService;
import com.dalin.hosting.domain.program.menu.Menu;
import com.dalin.hosting.domain.program.menu.MenuService;
import com.dalin.hosting.domain.user.User;
import com.dalin.hosting.domain.user.UserService;
import com.dalin.hosting.domain.user.auth.UserAuth;
import com.dalin.hosting.domain.user.auth.UserAuthService;
import com.dalin.hosting.domain.user.auth.menu.AuthGroupMenu;
import com.dalin.hosting.domain.user.auth.menu.AuthGroupMenuService;
import com.dalin.hosting.domain.user.role.UserRole;
import com.dalin.hosting.domain.user.role.UserRoleService;
...
public class DatabaseInitService {
    ...
    public void createDefaultData() throws IOException {
        ...
        /*
        programService.save(Program.of("api", "API", "/swagger/", "_self", "N", "Y", "Y", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("ax5ui-sample", "UI Template", "/jsp/_samples/ax5ui-sample.jsp", "_self", "Y", "Y", "Y", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("axboot-js", "[API]axboot.js", "/jsp/_apis/axboot-js.jsp", "_self", "N", "N", "N", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("basic", "Basic Template", "/jsp/_samples/basic.jsp", "_self", "Y", "Y", "Y", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("grid-form", "Grid & Form", "/jsp/_samples/grid-form.jsp", "_self", "Y", "Y", "Y", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("grid-modal", "Modal Template", "/jsp/_samples/grid-modal.jsp", "_self", "Y", "Y", "Y", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("grid-tabform", "Grid & Form with Tab ", "/jsp/_samples/grid-tabform.jsp", "_self", "Y", "Y", "Y", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("horizontal-layout", "Top-Bottom Layout", "/jsp/_samples/horizontal-layout.jsp", "_self", "N", "N", "N", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("login", "Login", "/jsp/login.jsp", "_self", "N", "N", "N", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("main", "Main", "/jsp/main.jsp", "_self", "N", "N", "N", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("page-structure", "Page Structure", "/jsp/_samples/page-structure.jsp", "_self", "N", "N", "N", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("system-auth-user", "User Mgmt", "/jsp/system/system-auth-user.jsp", "_self", "Y", "Y", "Y", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("system-config-common-code", "Common Code Mgmt", "/jsp/system/system-config-common-code.jsp", "_self", "Y", "Y", "Y", "Y", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("system-config-menu", "Menu Mgmt", "/jsp/system/system-config-menu.jsp", "_self", "Y", "Y", "Y", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("system-config-program", "Program Mgmt", "/jsp/system/system-config-program.jsp", "_self", "Y", "Y", "Y", "N", "N", "N", "N", "N", "N", "N"));
        programService.save(Program.of("system-operation-log", "ErrorLog Mgmt", "/jsp/system/system-operation-log.jsp", "_self", "Y", "Y", "N", "N", "N", "N", "N", "N", "N", "N"));
        ...
        */
        ...
        /*
        commonCodeService.save(CommonCode.of("USER_STATUS","Account Status","ACCOUNT_LOCK","Locked",2));
        commonCodeService.save(CommonCode.of("USER_ROLE","UserRole","API","API Accessing Role",6));
        commonCodeService.save(CommonCode.of("USER_ROLE","UserRole","ASP_ACCESS","ASP Accessing Role",1));
        commonCodeService.save(CommonCode.of("USER_ROLE","UserRole","ASP_MANAGER","Normal Admin Role",3));
        commonCodeService.save(CommonCode.of("LOCALE","Locale","en_US","English",2));
        commonCodeService.save(CommonCode.of("LOCALE","Locale","ko_KR","Korea",1));
        commonCodeService.save(CommonCode.of("DEL_YN","Whether or not to delete","N","Not Deleted",1));
        commonCodeService.save(CommonCode.of("USE_YN","Whether or not to use","N","Not Used",2));
        commonCodeService.save(CommonCode.of("USER_STATUS","Account Status","NORMAL","Enabled",1));
        commonCodeService.save(CommonCode.of("AUTH_GROUP","Authentication Group","S0001","System Auth Group",1));
        commonCodeService.save(CommonCode.of("AUTH_GROUP","Authentication Group","S0002","User Auth Group",2));
        commonCodeService.save(CommonCode.of("MENU_GROUP","MenuGroup","SYSTEM_MANAGER","System Mgmt Group",1));
        commonCodeService.save(CommonCode.of("USER_ROLE","UserRole","SYSTEM_MANAGER","System Admin Role",2));
        commonCodeService.save(CommonCode.of("MENU_GROUP","MenuGroup","USER","User Group",2));
        commonCodeService.save(CommonCode.of("DEL_YN","Whether or not to delete","Y","Deleted",2));
        commonCodeService.save(CommonCode.of("USE_YN","Whether or not to use","Y","Use",1));
        */
